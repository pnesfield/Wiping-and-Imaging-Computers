...
public:
	...
	bool	GetFileVersion( const TCHAR* kstrFileFormat
							, CString& strFileVersion ) const;

	// Get the file version string. The order is Major, Minor, Release and Build
	// Number with a dot between. For instance: "12.1.0.530".
	bool	GetFileVersion( CString& strFileVersion ) const;
...
private:
	...
	// constructor.
	bool DetermineFileVersion( const TCHAR* kstrFilePath );
...
private:
	...
	static const TCHAR kVersionFormat[];
